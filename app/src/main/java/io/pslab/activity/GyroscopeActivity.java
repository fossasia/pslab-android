...
public class GyroscopeActivity extends PSLabSensor {
    ...
    private void reinstateConfigurations() {
        ...
        GyroscopeDataFragment.setParameters(
                Float.parseFloat(gyroscopeConfigurations.getString(GyroscopeSettingsFragment.KEY_HIGH_LIMIT, "20")),
                Integer.parseInt(gyroscopeConfigurations.getString(GyroscopeSettingsFragment.KEY_UPDATE_PERIOD, "1000")),
