...
//            x_accel_max.setText(getResources().getString(R.string.recorder));
//            y_accel_max_text.setText(getResources().getString(R.string.recorder));
    ...
    private void writeLogToFile(long timestamp, float sensorReading) {
        ...
        if (getActivity() != null && accelerometerSensor.isRecording) {
            ...
            if (accelerometerSensor.addLocation && accelerometerSensor.gpsLogger.isGPSEnabled()) {
                String dateTime = accelerometerSensor.dateFormat.format(new Date(timestamp));
    ...
    private void initiateAccelerometerSensor(int type) {
        ...
        switch (s) {
            ...
            case BH1750_SENSOR:
                ...
                break;
            case TSL2561_SENSOR:
                //z_accel_max_text.setText(getResources().getStringArray(R.array.lux_sensors)[2]);
                scienceLab = ScienceLabCommon.scienceLab;
                if (scienceLab.isConnected()) {
                    try {
                        I2C i2c = scienceLab.i2c;
