package com.fossasia.pslab.fragment;
...
import com.fossasia.pslab.adapters.ApplicationsAdapter;
...
public class ApplicationsFragment extends Fragment {
    ...
    private int[] imageList = {R.drawable.osciloscope, R.drawable.control, R.drawable.advance, R.drawable.la, R.drawable.sensor, R.drawable.wirelesssensor, R.drawable.sensor_quickview, R.drawable.wireless_sensor_quickview};
