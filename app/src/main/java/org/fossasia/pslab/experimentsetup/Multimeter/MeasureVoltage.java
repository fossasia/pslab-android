package org.fossasia.pslab.experimentsetup.Multimeter;
...
/**
 * Created by dell pc on 16/09/2017.
 */

public class MeasureVoltage extends android.support.v4.app.Fragment {
    ...
    public static MeasureVoltage  newInstance() {
        return new MeasureVoltage();
    }
