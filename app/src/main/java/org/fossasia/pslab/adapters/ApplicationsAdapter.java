...
public class ApplicationsAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.tv = (TextView) rowView.findViewById(org.fossasia.pslab.R.id.application_tv);
        holder.img = (ImageView) rowView.findViewById(org.fossasia.pslab.R.id.application_icon);
