...
public class SensorFragmentMLX90614 extends Fragment {
    ...
    private class SensorDataFetch extends AsyncTask<Void, Void, Void> {
        MLX90614 MLX90614 = new MLX90614(i2c);
        ...
        protected Void doInBackground(Void... params) {
            try {
                if (MLX90614 != null) {
                    dataMLX90614ObjectTemp = MLX90614.getObjectTemperature();
                    dataMLX90614AmbientTemp = MLX90614.getAmbientTemperature();
                }
            } catch (IOException e) {
                e.printStackTrace();
            }
