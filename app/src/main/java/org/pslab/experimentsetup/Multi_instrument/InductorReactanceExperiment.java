...
public class InductorReactanceExperiment extends Fragment{
    ...
    public static InductorReactanceExperiment newInstance() {
        return new InductorReactanceExperiment();
    }
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                ...
                for (float i = 0; i < 2000; i += 1) {
                    new InductorReactanceExperiment.CalcDataPoint().execute(i);
                    synchronized (lock) {
                        try {
                            lock.wait();
