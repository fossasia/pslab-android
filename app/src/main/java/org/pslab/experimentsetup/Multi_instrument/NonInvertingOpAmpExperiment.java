package org.pslab.experimentsetup.Multi_instrument;
...
public class NonInvertingOpAmpExperiment extends Fragment{
    ...
    public static NonInvertingOpAmpExperiment newInstance() {
        return new NonInvertingOpAmpExperiment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        opampGain = view.findViewById(R.id.opamp_gain);
        ...
        btnConfigure.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MaterialDialog dialog = new MaterialDialog.Builder(getActivity())
                        ...
                        .customView(R.layout.non_inverting_opamp_dialog, true)
                        ...
                        .onPositive(new MaterialDialog.SingleButtonCallback() {
                            ...
                            public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                                ...
                                etFrequency = customView.findViewById(R.id.opamp_frequency);
                                tilFrequency = customView.findViewById(R.id.opamp_frequency_layout);
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                ...
                for (float i = 0; i < 2000; i += 1) {
                    new NonInvertingOpAmpExperiment.CalcDataPoint().execute(i);
                    synchronized (lock) {
                        try {
                            lock.wait();
