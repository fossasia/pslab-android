...
public class LRPhaseShiftExperiment extends Fragment{
    ...
    public static LRPhaseShiftExperiment newInstance() {
        return new LRPhaseShiftExperiment();
    }

    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {

        View view = inflater.inflate(R.layout.common_experiment_setup, container, false); //since the required layout is similar to common_experiment_setup, it has been reused
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                ...
                for (float i = 0; i < 2000; i += 1) {
                    new LRPhaseShiftExperiment.CalcDataPoint().execute(i);
                    synchronized (lock) {
                        try {
                            lock.wait();
