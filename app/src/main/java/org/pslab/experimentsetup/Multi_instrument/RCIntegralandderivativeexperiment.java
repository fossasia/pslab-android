...
public class RCIntegralandderivativeexperiment extends Fragment {
    ...
    public static RCIntegralandderivativeexperiment newInstance() {
        return new RCIntegralandderivativeexperiment();
    }
