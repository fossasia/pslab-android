...
public class RCPhaseShiftExperiment extends Fragment{
    ...
    public static RCPhaseShiftExperiment newInstance() {
        return new RCPhaseShiftExperiment();
    }
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                ...
                for (float i = 0; i < 2000; i += 1) {
                    new RCPhaseShiftExperiment.CalcDataPoint().execute(i);
                    synchronized (lock) {
                        try {
                            lock.wait();
