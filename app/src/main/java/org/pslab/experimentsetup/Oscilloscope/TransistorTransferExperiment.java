package org.pslab.experimentsetup.Oscilloscope;
...
import org.pslab.experimentsetup.ExperimentErrorStrings;
                ...
                MaterialDialog dialog = new MaterialDialog.Builder(getActivity())
                        ...
                        .onPositive(new MaterialDialog.SingleButtonCallback() {
                            ...
                            public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                                ...
                                etInitialVoltage = customView.findViewById(R.id.bjt_transfer_initial_voltage);
                                etFinalVoltage = customView.findViewById(R.id.bjt_transfer_final_voltage);
                                etStepSize = customView.findViewById(R.id.bjt_transfer_step_size);
                                etCollectorVoltage = customView.findViewById(R.id.bjt_transfer_collector_voltage);
                                tilInitialVoltage = customView.findViewById(R.id.bjt_transfer_initial_voltage_layout);
                                tilFinalVoltage = customView.findViewById(R.id.bjt_transfer_final_voltage_layout);
                                tilStepSize = customView.findViewById(R.id.bjt_transfer_step_size_layout);
                                tilCollectorVoltage = customView.findViewById(R.id.bjt_transfer_collector_voltage_layout);
                                // Initial Voltage
