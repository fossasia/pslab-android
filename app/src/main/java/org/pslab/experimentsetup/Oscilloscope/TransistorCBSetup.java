                ...
                MaterialDialog dialog = new MaterialDialog.Builder(getActivity())
                        ...
                        .onPositive(new MaterialDialog.SingleButtonCallback() {
                            ...
                            public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                                ...
                                etTotalSteps = customView.findViewById(R.id.et_total_steps);
                                etEmitterVoltage = customView.findViewById(R.id.et_emitter_voltage);
                                ...
                                tilTotalSteps = customView.findViewById(R.id.text_input_layout_total_steps);
                                tilEmitterVoltage = customView.findViewById(R.id.text_input_layout_voltage);
                                // Initial Voltage
